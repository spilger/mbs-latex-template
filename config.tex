...
% FONT SELECTION
\usepackage{fontspec}
\setmainfont{Times New Roman} % Ensure Times New Roman font
\fontsize{12pt}{14pt}\selectfont % Set font size to 12 pt with appropriate line spacing
\doublespacing % Ensure double spacing
